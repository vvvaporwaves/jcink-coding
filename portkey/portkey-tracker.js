...
CHARACTERS.add("portia koleva");
CHARACTERS.add("titania elwyn");
CHARACTERS.add("diego de leon");
CHARACTERS.add("xenia maylands");
...
const isLastPoster = (docText) => {
  ...
  let postName = el.querySelectorAll(".post-wrapper #mini-profile-header-container .post-name a span");
...
window.addEventListener("load", (event) => {
  ...
  // Get all threads.
  let threads = document.querySelectorAll(".tia-thread,.nia-thread,.diego-thread,.xenia-thread");
